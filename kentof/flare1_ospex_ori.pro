...
if keyword_set(left) then dat = area_limit(data, center, radius, /xy,/left) $
	else dat = area_limit(data, center, radius, /xy)
if keyword_set(right) then dat = area_limit(data, center, radius, /xy,/right) $
        else dat = dat
if keyword_set(top) then dat = area_limit(data, center, radius, /xy,/top) $
        else dat = dat
if keyword_set(bottom) then dat = area_limit(data, center, radius, /xy,/bottom) $
        else dat = dat
